...
#include <memory>
#include "../ChargingCarAuto/tab2database.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Tab2DataBase_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Tab2DataBase_t qt_meta_stringdata_Tab2DataBase = {
    {
QT_MOC_LITERAL(0, 0, 12), // "Tab2DataBase"
QT_MOC_LITERAL(1, 13, 16), // "slotTab2RecvData"
...
void Tab2DataBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Tab2DataBase *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Tab2DataBase::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Tab2DataBase.data,
    qt_meta_data_Tab2DataBase,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Tab2DataBase::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Tab2DataBase.stringdata0))
